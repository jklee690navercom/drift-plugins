...
function renderCharts(data, events) {
    ...
    if (events.length > 0 && events[0].detail) {
        ...
        meanScoreSeries = events[0].detail.rolling_mean_score_series || [];
        stdScoreSeries = events[0].detail.rolling_std_score_series || [];
        diffScoreSeries = events[0].detail.rolling_diff_score_series || [];
    }
    ...
    statChart = new Chart(statCtx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: meanScoreSeries,
                borderColor: '#3b82f6',
                borderWidth: 1.5,
                pointRadius: 0,
                fill: false,
            }, {
                label: 'Rolling Std Score',
                data: stdScoreSeries,
                borderColor: '#22c55e',
                borderWidth: 1.5,
                pointRadius: 0,
                ...
                label: 'Rolling Diff Score',
                data: diffScoreSeries,
                borderColor: '#f97316',
                borderWidth: 1.5,
                pointRadius: 0,
                fill: false,
